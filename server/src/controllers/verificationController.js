...
export const runServiceByName = async (req, res) => {
  try {
    ...
    const serviceMap = {
      ...
      'aadhaar-fetch-without-otp': 'aadhaar-fetch-without-otp',
      'aadhaar-without-otp': 'aadhaar-fetch-without-otp',
      'aadhar-fetch-without-otp': 'aadhaar-fetch-without-otp',
      'aadhar-without-otp': 'aadhaar-fetch-without-otp',
      ...
      'mobile-to-bank': 'mobile-to-bank-advance',
      'mobile-to-bank-advance': 'mobile-to-bank-advance',
      'mobile-bank-advance': 'mobile-to-bank-advance',
      'mobile-upi-lookup-enhanced': 'mobile-upi-lookup-enhanced',
      'mobile-upi-lookup': 'mobile-upi-lookup-enhanced',
      'mobile-upi-enhanced': 'mobile-upi-lookup-enhanced',
      'upi-lookup': 'mobile-upi-lookup-enhanced',
      ...
      'cibil-hybrid': 'cibil-transunion-pdf',
      'cibil-transunion-v5': 'cibil-transunion-pdf',
